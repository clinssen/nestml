...
class VariableSymbol(Symbol):
    ...
    def is_ode_defined(self):
        ...
        :rtype: bool
        """
        return self.ode_or_kernel is not None and (isinstance(self.ode_or_kernel, ASTExpression) or
                                                     isinstance(self.ode_or_kernel, ASTSimpleExpression) or
                                                     isinstance(self.ode_or_kernel, ASTKernel) or
                                                     isinstance(self.ode_or_kernel, ASTOdeEquation))
