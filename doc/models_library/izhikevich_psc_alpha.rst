...
izhikevich_psc_alpha - Detailed Izhikevich neuron model with alpha-kerneld post-synaptic current
...
On each spike arrival, the membrane potential feels an alpha-kerneld current of the form:
